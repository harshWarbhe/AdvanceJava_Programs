...
public class PSBlobInsertTestOracle {
	private static final String INSERT_ACTRESS_QUERY = "INSERT INTO ACTRESS_INFO VALUES(AID_SEQ.NEXTVAL,?,?,?)";
		...
		try (sc;) {
			...
			try (InputStream is = new FileInputStream(photoLocation)) {
				...
				try (Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl", "harsh",
						"tiger"); PreparedStatement ps = con.prepareStatement(INSERT_ACTRESS_QUERY);) {
